...
from shortame.adapters.redis_adapter import (AbstractCacheQueue,
                                             ...
                                             FakeCacheQueue, FakeShortUrlQueue,
...
class FakeUrlShortener(AbstractUrlShortener):
    def __init__(
        self,
        table: AbstractDynamoDBUrlTable,
        queue: AbstractUrlQueue = FakeShortUrlQueue,
        cache: AbstractCacheQueue = FakeCacheQueue,
        ...
        def shorten_and_persist(self, long_url: str) -> str:
